...
(function (Fabrique) {
    var WindowCharacteristics = /** @class */ (function (_super) {
        ...
        WindowCharacteristics.prototype.showCharacteristics = function (personageID) {
            ...
            GameData.Data.personages.forEach(function (personage) {
                if (personage.id === personageID) {
                    _this.textValueCap1.text = Constants.LEG + " x " + personage.leg;
                    _this.textValueCap2.text = Constants.HAND + " x " + personage.hand;
                    _this.textValueCap3.text = Constants.BLOCK + " x " + personage.block;
                    _this.textValueCap4.text = Constants.UPPERCUT + " x " + personage.uppercut;
                    _this.textValueCap5.text = Constants.TWIST + " x " + personage.twist;
                    return;
                }
            });
        };
